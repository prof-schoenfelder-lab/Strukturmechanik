...
| Hilfe-Warteschlange | Der 🙋-Button ist standardmäßig AUS und wird im Dashboard für die Lehrveranstaltung ein-/ausgeschaltet (Schalter über der Warteschlange; Ausschalten schließt offene Meldungen). Studierende melden sich über den Button unten rechts auf jeder Kursseite (geht auch ohne Login — Zuordnung dann über die Pool-IP). Das Dashboard zeigt die Warteschlange in Meldereihenfolge mit Platz/Name/Seite/Wartezeit; „✓ erledigt" schließt das Ticket und der Button beim Studierenden meldet „Hilfe ist unterwegs". Offene Tickets verfallen nach 3 h automatisch. |
