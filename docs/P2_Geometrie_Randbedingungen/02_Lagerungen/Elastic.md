...
Näherungsweise für eine elastische Schicht berechnet sich die Fundamentsteifigkeit $k$ aus dem Elastizitätsmodul $E$ und der Schichtdicke $h$ zu:
...
!!! hint "Hinweis"
    ...
    Die elastische Bettung ist ein Flächenbezogener Wert, je größer die Fläche ist auf der diese angewendet wird, desto steifer auch die Bettung.